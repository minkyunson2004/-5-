...
public class HardScoreGamePanel extends JPanel {
    ...
    public HardScoreGamePanel(MainFrame superFrame) {
...
//		buffg.drawString(Integer.toString(resultScore), 700, 85);
    ...
    private void makeMo() {
        ...
        mo1 = new MapObjectImg(new GameBackground("img/game/HardScore/map1img/bg1.png"), new ImageIcon("img/game/HardScore/map1img/bg2.png"),
                ...
                new ImageIcon("img/game/HardScore/map1img/fieldIc1.png"), new ImageIcon("img/game/HardScore/map1img/fieldIc2.png"),
                new ImageIcon("img/game/HardScore/map1img/tacle1.gif"), new ImageIcon("img/game/HardScore/map1img/tacle2.png"),
                new ImageIcon("img/game/HardScore/map1img/tacle3.png"), new ImageIcon("img/game/HardScore/map1img/tacle3.png"));

        mo2 = new MapObjectImg(new GameBackground("img/game/HardScore/map2img/back1.png"), new ImageIcon("img/game/HardScore/map2img/back2.png"),
                new ImageIcon("img/game/Common/jelly/jelly1.png"), new ImageIcon("img/game/Common/jelly/jelly2.png"),
                new ImageIcon("img/game/Common/jelly/jelly3.png"), new ImageIcon("img/game/Common/jelly/life.png"),
                new ImageIcon("img/game/Common/effectTest.png"),
                new ImageIcon("img/game/HardScore/map2img/field1.png"), new ImageIcon("img/game/HardScore/map2img/field2.png"),
                new ImageIcon("img/game/HardScore/map2img/tacle1.png"), new ImageIcon("img/game/HardScore/map2img/tacle2.png"),
                new ImageIcon("img/game/HardScore/map2img/tacle3.png"), new ImageIcon("img/game/HardScore/map2img/tacle3.png"));

        mo3 = new MapObjectImg(new GameBackground("img/game/HardScore/map3img/bg.png"), new ImageIcon("img/game/HardScore/map3img/bg2.png"),
                new ImageIcon("img/game/Common/jelly/jelly1.png"), new ImageIcon("img/game/Common/jelly/jelly2.png"),
                new ImageIcon("img/game/Common/jelly/jelly3.png"), new ImageIcon("img/game/Common/jelly/life.png"),
                new ImageIcon("img/game/Common/effectTest.png"),
                new ImageIcon("img/game/HardScore/map3img/field.png"), new ImageIcon("img/game/HardScore/map3img/field2.png"),
                new ImageIcon("img/game/HardScore/map3img/tacle1.png"), new ImageIcon("img/game/HardScore/map3img/tacle2.png"),
                new ImageIcon("img/game/HardScore/map3img/tacle3.png"), new ImageIcon("img/game/HardScore/map3img/tacle3.png"));

        mo4 = new MapObjectImg(new GameBackground("img/game/HardScore/map4img/bback.png"), new ImageIcon("img/game/HardScore/bback2.png"),
                new ImageIcon("img/game/Common/jelly/jelly1.png"), new ImageIcon("img/game/Common/jelly/jelly2.png"),
                new ImageIcon("img/game/Common/jelly/jelly3.png"), new ImageIcon("img/game/Common/jelly/life.png"),
                new ImageIcon("img/game/Common/effectTest.png"),
                new ImageIcon("img/game/HardScore/map4img/ffootTest.png"), new ImageIcon("img/game/HardScore/map4img/ffootTest2.png"),
                new ImageIcon("img/game/HardScore/map4img/tacle1.png"), new ImageIcon("img/game/HardScore/map4img/tacle2.png"),
                new ImageIcon("img/game/HardScore/map4img/tacle2.png"), new ImageIcon("img/game/HardScore/map4img/tacle2.png"));
    ...
    private void initMap(int num, int mapLength) {
        ...
        if (num == 1) {
            tempMap = "img/game/HardScore/map1.png";
        } else if (num == 2) {
            tempMap = "img/game/HardScore/map2.png";
        } else if (num == 3) {
            tempMap = "img/game/HardScore/map3.png";
        } else if (num == 4) {
            tempMap = "img/game/HardScore/map4.png";
        }
            ...
            public void run() {
                while (true) {
                    ...
                    if (foot > 1999 || c1.getHealth() < 1) {
                        superFrame.getHardScoreEndPanel().setResultScore(resultScore);
                        cl.show(superFrame.getContentPane(), "HardScoreEndPanel");
