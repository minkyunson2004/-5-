...
public class NormalScoreGamePanel extends JPanel {
...
//		buffg.drawString(Integer.toString(resultScore), 700, 85);
    ...
    private void makeMo() {
        ...
        mo1 = new MapObjectImg(new GameBackground("img/game/NormalScore/map1img/bg1.png"), new ImageIcon("img/game/NormalScore/map1img/bg2.png"),
                ...
                new ImageIcon("img/game/NormalScore/map1img/fieldIc1.png"), new ImageIcon("img/game/NormalScore/map1img/fieldIc2.png"),
                new ImageIcon("img/game/NormalScore/map1img/tacle1.gif"), new ImageIcon("img/game/NormalScore/map1img/tacle2.png"),
                new ImageIcon("img/game/NormalScore/map1img/tacle3.png"), new ImageIcon("img/game/NormalScore/map1img/tacle3.png"));

        mo2 = new MapObjectImg(new GameBackground("img/game/NormalScore/map2img/back1.png"), new ImageIcon("img/game/NormalScore/map2img/back2.png"),
                new ImageIcon("img/game/Common/jelly/jelly1.png"), new ImageIcon("img/game/Common/jelly/jelly2.png"),
                new ImageIcon("img/game/Common/jelly/jelly3.png"), new ImageIcon("img/game/Common/jelly/life.png"),
                new ImageIcon("img/game/Common/effectTest.png"),
                new ImageIcon("img/game/NormalScore/map2img/field1.png"), new ImageIcon("img/game/NormalScore/map2img/field2.png"),
                new ImageIcon("img/game/NormalScore/map2img/tacle1.png"), new ImageIcon("img/game/NormalScore/map2img/tacle2.png"),
                new ImageIcon("img/game/NormalScore/map2img/tacle3.png"), new ImageIcon("img/game/NormalScore/map2img/tacle3.png"));

        mo3 = new MapObjectImg(new GameBackground("img/game/NormalScore/map3img/bg.png"), new ImageIcon("img/game/NormalScore/map3img/bg2.png"),
                new ImageIcon("img/game/Common/jelly/jelly1.png"), new ImageIcon("img/game/Common/jelly/jelly2.png"),
                new ImageIcon("img/game/Common/jelly/jelly3.png"), new ImageIcon("img/game/Common/jelly/life.png"),
                new ImageIcon("img/game/Common/effectTest.png"),
                new ImageIcon("img/game/NormalScore/map3img/field.png"), new ImageIcon("img/game/NormalScore/map3img/field2.png"),
                new ImageIcon("img/game/NormalScore/map3img/tacle1.png"), new ImageIcon("img/game/NormalScore/map3img/tacle2.png"),
                new ImageIcon("img/game/NormalScore/map3img/tacle3.png"), new ImageIcon("img/game/NormalScore/map3img/tacle3.png"));

        mo4 = new MapObjectImg(new GameBackground("img/game/NormalScore/map4img/bback.png"), new ImageIcon("img/game/NormalScore/bback2.png"),
                new ImageIcon("img/game/Common/jelly/jelly1.png"), new ImageIcon("img/game/Common/jelly/jelly2.png"),
                new ImageIcon("img/game/Common/jelly/jelly3.png"), new ImageIcon("img/game/Common/jelly/life.png"),
                new ImageIcon("img/game/Common/effectTest.png"),
                new ImageIcon("img/game/NormalScore/map4img/ffootTest.png"), new ImageIcon("img/game/NormalScore/map4img/ffootTest2.png"),
                new ImageIcon("img/game/NormalScore/map4img/tacle1.png"), new ImageIcon("img/game/NormalScore/map4img/tacle2.png"),
                new ImageIcon("img/game/NormalScore/map4img/tacle2.png"), new ImageIcon("img/game/NormalScore/map4img/tacle2.png"));
    ...
    private void initMap(int num, int mapLength) {
        ...
        if (num == 1) {
            tempMap = "img/game/NormalScore/map1.png";
        } else if (num == 2) {
            tempMap = "img/game/NormalScore/map2.png";
        } else if (num == 3) {
            tempMap = "img/game/NormalScore/map3.png";
        } else if (num == 4) {
            tempMap = "img/game/NormalScore/map4.png";
        }
            ...
            public void run() {
                while (true) {
                    ...
                    if (foot > 1999 || c1.getHealth() < 1) {
                        superFrame.getNormalScoreEndPanel().setResultScore(resultScore);
                        cl.show(superFrame.getContentPane(), "NormalScoreEndPanel");
                    ...
                    try{
                        if(mapLength >= mapLengthList.get(2) * 40 + 800 && (mapLength - (mapLengthList.get(2) * 40 + 800)) % (Util.getSize("img/game/HardScore/map4.png")[0] * 40)== 0) {
                            initMap(4, Util.getSize("img/game/NormalScore/map4.png")[0] + 20);
                            mapLength -= Util.getSize("img/game/NormalScore/map4.png")[0];
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
